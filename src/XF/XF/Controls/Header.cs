...
namespace XF.Controls
{
    ...
    public interface IHeaderViewModel
	{
		...
		ImageSource HeaderRightIconSource { get; set; }
		ImageSource HeaderLeftIconSource { get; set; }
		ICommand HeaderRightCommand { get; set; }
		ICommand HeaderLeftCommand { get; set; }
	}
}
